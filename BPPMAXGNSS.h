...
namespace BPPMAXGNSS
{
    ...
    class CFG_NAV5_EngineSettings: protected UBXMsg
    {
        public:
            ...
            //bools for mask
            bool ReservedBit0[8];bool dgpsMask;bool staticHoldMask;bool timeMask;bool posMask;bool drLim;bool posFixMode;bool minEl;bool dyn;
    ...
    class CFG_NMEA_Deprecated: protected UBXMsg
    {
        public:
            ...
            //bools for filter
            bool trackFilt;bool gpsOnlyFilter;bool dateFilt;bool timeFilt;bool mskPosFilt;bool posFilt;
    ...
    class CFG_NMEA: protected UBXMsg
    {
        public:
            ...
            bool glonass;bool qzss;bool sbas;bool gps;
    ...
    class CFG_PRT_UART: protected UBXMsg
    {
        public:
            ...
            //bools for txReady
            bool thres[9];bool pin[5];bool pol;bool en;

            uint32_t mode;    // Bitfield
            //bools for mode
            bool nStopBits[2];bool parity[3];bool charLen[2];bool reserved1;

            uint32_t baudRate;

            uint16_t inProtoMask;    // Bitfield
            //bools for inProtoMask
            bool inRtcm;bool inNmea;bool inUbx;

            uint16_t outProtoMask;    // Bitfield
            //bools for outProtoMask
            bool outNmea;bool outUbx;
...
///////////////////////////////////////////////////////
    ...
    class NAV_PVT_Solution: protected UBXMsg
    {
        public:
            ...
            //Bools for valid
            bool validDate;bool validTime;bool fullyResolved;
            ...
            uint8_t flags;    // Bitfield
            //Bools for flags
            bool gnssFixOK;bool diffSoln;bool psmState[3];
    ...
    class NAV_SOL_Solution: protected UBXMsg
    {
        public:
            ...
            bool GPSfixOK;bool DiffSoln;bool WKNSET;bool TOWSET;
    ...
    class NAV_STATUS: protected UBXMsg
    {
        public:
            ...
            //bools for fixStat
            bool dgpsIStat;bool mapMatching[2];
    ...
    class NAV_TIMEUTC: protected UBXMsg
    {
        public:
            ...
            uint8_t valid;    //Bitfield
            //Bools for valid
            bool validTOW;bool validWKN;bool validUTC;
    };
    ...
    class BPPMAXGNSS
    {
        public:
            ...
            uint8_t sendBytes(uint8_t* msg, uint8_t msgLength);bool getUBX_ACK(uint8_t *msg);
